...
abstract class AbstractAlgorithmsTests {
    ...
    fun longestCommonSubstring(longestCommonSubstring: (String, String) -> String) {
        ...
        assertEquals("String", longestCommonSubstring("SomeString", "SOMEString"))
        assertEquals("tring", longestCommonSubstring("SOMEstring", "SOMEString"))
        assertEquals("п", longestCommonSubstring("привет", "пока"))
        assertEquals(
