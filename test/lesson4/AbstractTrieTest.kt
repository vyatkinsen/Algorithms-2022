...
abstract class AbstractTrieTest {
    ...
    protected fun doIteratorTest() {
        ...
        //My test
        val controlSet = mutableSetOf("style", "styler", "stylist", "stylistic", "07111917", "08111917")
        println("Control set: $controlSet")
        val trieSet = create()
        assertFalse(
            trieSet.iterator().hasNext(),
    ...
    protected fun doIteratorRemoveTest() {
        ...
        //My test
        val controlSet = mutableSetOf("hen", "fitness", "volunteer", "astonishing", "seize", "imperial", "war", "worm", "behead")
        println("Control set: $controlSet")
